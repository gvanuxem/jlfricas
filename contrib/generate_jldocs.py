...
NM_CATEGORIES = [
    "NMCommutativeRing", "NMField", "NMPadicNumberCategory", "NMPolynomialCategory",
    "NMUnivariatePolynomialCategory", "NMRing", "NMType",
]
...
NM_DOMAINS = [
    ...
    "NMPadic", "NMPolynomial", "NMPrimeField", "NMResidueField", "NMResidueRing",
    "NMQadic", "NMRealBall", "NMRealField", "NMUnivariateLaurentPolynomial",
