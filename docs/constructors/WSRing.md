...
> **Kind**: Category &nbsp;|&nbsp; \[[Source](https://github.com/gvanuxem/jlfricas/blob/master/src/algebra/jws.spad#L95)\] &nbsp;|&nbsp; **Group**: WS — MathLink

## Description

Julia WS category for rings using the Wolfram Symbol Transport Protocol.
...
| Operation | Summary |
| :--- | :--- |
| [`*`](#op-mul) | Operation defined in WSRing |
| [`+`](#op-add) | Operation defined in WSRing |
...
| [`^`](#op-pow) | Operation defined in WSRing |
...
| [`~=`](#op-neq) | Operation defined in WSRing |
