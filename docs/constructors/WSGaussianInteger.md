...
> **Kind**: Domain &nbsp;|&nbsp; \[[Source](https://github.com/gvanuxem/jlfricas/blob/master/src/algebra/jws.spad#L1098)\] &nbsp;|&nbsp; **Group**: WS — Wolfram/MathLink
...
### `coerce` &nbsp; \[[source](https://github.com/gvanuxem/jlfricas/blob/master/src/algebra/jws.spad#L1113)\]

coerce(x): convenience function.

- **Signature**: `Integer -> %`

### `jWSGI` &nbsp; \[[source](https://github.com/gvanuxem/jlfricas/blob/master/src/algebra/jws.spad#L1115)\]

jWSGI(re, im) constructs a WSGaussianInteger from real part re and imaginary part im.

- **Signature**: `(WSInteger, WSInteger) -> %`

### `random` &nbsp; \[[source](https://github.com/gvanuxem/jlfricas/blob/master/src/algebra/jws.spad#L1110)\]
