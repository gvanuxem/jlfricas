...
[![Generate jlFriCAS Documentation](https://github.com/gvanuxem/jlfricas/actions/workflows/generateDocs.yml/badge.svg)](https://github.com/gvanuxem/jlfricas/actions/workflows/generateDocs.yml)
...
The MCP server is also used by [fricas-vscode](https://github.com/gvanuxem/fricas-vscode) (the Julia interface is not necessary nor the use of a LLM). The server includes a built-in JSON-RPC codec with no external Common Lisp dependencies.
...
![Capture1](https://github.com/user-attachments/assets/f570c6ea-b472-4053-b8c5-957d0defcc35)
...
![Capture2](https://github.com/user-attachments/assets/c1835c3b-efff-495a-a3e6-ff5958d08ffa)

### Julia Plots on Windows/cmd.exe:

![Capture3](https://github.com/user-attachments/assets/0633a734-f0f1-4712-9285-c9230446e2da)

### Linear Algebra:

![Capture4](https://github.com/user-attachments/assets/e63e2e54-226c-45e9-84ea-37e4dd1843fc)
