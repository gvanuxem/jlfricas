...
(|basic|
  ...
  (|JuliaFloat64VectorFunctions2| . JF64VEC2)
  (|JuliaDataFrame| . JDFRAME)
  (|JuliaInt64| . JI64)
  ...
  (|JuliaF64LinearAlgebra| . JF64LA)
  (|JuliaStringUtilities| . JSTRU)
  (|JuliaUtilityFunctions| . JUF)
  (|JuliaSymbol| . JSYM)
  (|JuliaVector| . JVECTOR)
  (|JuliaVectorFunctions2| . JVECTOR2)
  (|JuliaWSAPComplex| . JWSAPCPX)
  (|JuliaWSAPReal| . JWSAPR)
  (|JuliaWSComplex| . JWSCPLX)
  (|JuliaWSExpression| . JWSEXPR)
  (|JuliaWSGaussianInteger| . JWSGINT)
  (|JuliaWSInteger| . JWSINT)
  (|JuliaWSList| . JWSLIST)
  (|JuliaWSMatrix| . JWSMAT)
  (|JuliaWSNumericalSpecialFunctions| . JWSNSF)
  (|JuliaWSRational| . JWSRAT)
  (|JuliaWSReal| . JWSREAL)
  (|JuliaWSSymbol| . JWSSYM)
  (|JuliaWSUtilityFunctions| . JWSUF)
  (|JuliaWSVector| . JWSVEC)
  ...
  (|NemoComplexBall| . NCB)
  (|NemoComplexField| . NCF)
  (|NemoExactCalciumField| . NECF)
  (|NemoFactored| . NFR)
  (|NemoFiniteField| . NFF)
  (|NemoFraction| . NFRAC)
  (|NemoInteger| . NINT)
  (|NemoIntegerMod| . NZMOD)
...
(|categories|
  ...
  (|JuliaMachineFloat| . JMFLOAT)
  (|JuliaMachineType| . JMTYPE)
  ...
  (|JuliaWSAggregate| . JWSAGG)
  (|JuliaWSNumber| . JWSNUM)
  (|JuliaWSObject| . JWSO)
  (|JuliaWSRing| . JWSRING)
...
(|Hidden|
  ...
  (|InnerNemoExactCalciumField| . INECF)
  ...
  (|JuliaF32ArrayFunctions| . JF32AF)
  (|JuliaF64ArrayFunctions| . JF64AF)
  (|JuliaCF32LinearAlgebra| . JCF32LA)
  (|JuliaCF64LinearAlgebra| . JCF64LA)
  (|JuliaComplexF32| . JCF32)
  (|JuliaComplexF32Matrix| . JCF32MAT)
  (|JuliaComplexF32SquareMatrix| . JCF32SMA)
  (|JuliaComplexF32Vector| . JCF32VEC)
  ...
  (|JuliaComplexFloat| . JCFLOAT)
  (|JuliaComplexFloatSpecialFunctions| . JCFSF)
  (|JuliaF32LinearAlgebra| . JF32LA)
  (|JuliaFloat32Matrix| . JF32MAT)
