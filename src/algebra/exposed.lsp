...
(|basic|
  ...
  (|JLWSAPComplex| . JWSAPCPX)
  (|JLWSAPReal| . JWSAPR)
  (|JLWSComplex| . JWSCPLX)
  (|JLWSExpression| . JWSEXPR)
  (|JLWSGaussianInteger| . JWSGINT)
  (|JLWSInteger| . JWSINT)
  (|JLWSList| . JWSLIST)
  (|JLWSMatrix| . JWSMAT)
  (|JLWSNumericalSpecialFunctions| . JWSNSF)
  (|JLWSRational| . JWSRAT)
  (|JLWSReal| . JWSREAL)
  (|JLWSSymbol| . JWSSYM)
  (|JLWSUtilityFunctions| . JWSUF)
  (|JLWSVector| . JWSVEC)
...
(|categories|
  ...
  (|NMAlgebraicallyClosedField| . NACF)
  (|NMAlgebraicallyClosedFunctionSpace| . NACFS)
